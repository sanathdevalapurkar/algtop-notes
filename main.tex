...
\def\cA{\mathscr A}\def\cB{\mathscr B}\def\cc{\mathbf C}\def\cd{\mathscr D}
...
\def\EE{\mathbb E}\def\FF{\mathbf F}\def\GG{\mathbb G}%\def H{ H}
...
\large{
    \begin{enumerate}
        \item The notes for 18.905 start at Chapter \ref{905}.
        \item The notes for 18.906 start at Chapter \ref{906}.
    \end{enumerate}
}
\end{abstract}
\newpage
...
\label{905}
\input{18-905-notes.tex}
\newpage
\part{18.906 -- homotopy theory}\label{906}
\input{18-906-notes.tex}
\end{document}
